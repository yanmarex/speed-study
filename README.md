...
My main goal for the rest of 2020 is to learn everything I need to be a competent professional software developer. For that I will follow P1xt guide 4.0.

My other goals are (not coding relate):

- [ ] Finish a light novel.
- [ ] Make a videogame on a GameJam.
- [ ] Make a Blender Scene.
- [ ] Compose a Music theme.
- [ ] Read 20 books.
